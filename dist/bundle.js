...
function isEqual() {
    ...
    var signElement = document.getElementById("Operator");
    var Operator = signElement.value; // fisker navnet ud fra min "Select".
    var TextInput = inputElement.value; // fisker navnet ud af min input field.
    switch (Operator) {
        case "ToUpper":
            result = TextInput.toUpperCase(); //code block statement1;
            break;
        case "ToLower":
            result = TextInput.toLowerCase(); //code block statement2;
            break;
    }
